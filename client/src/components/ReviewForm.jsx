        ...
        <div className={styles['review-form']}>
            ...
            <form onSubmit={handleSubmit} className={styles.reviewForm}>
                <div className={styles.formGroup}>
                    <label htmlFor="rating-stars" className={styles.formLabel}>Rating</label>
                    <div id="rating-stars" className={styles['rating-stars']} role="radiogroup" aria-label="Rating">
                        {[...Array(5)].map((_, index) => {
                ...
                <div className={styles.formGroup}>
                    <label htmlFor="review-comment" className={styles.formLabel}>Comment</label>
                    <textarea
                        id="review-comment"
